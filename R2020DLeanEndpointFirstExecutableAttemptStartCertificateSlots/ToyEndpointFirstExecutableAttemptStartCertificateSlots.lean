...
/-- Toy run: start-certificate slots forget to R2017D attempt-shell dependency audit. -/
def toy_endpoint_first_executable_attempt_start_certificate_slots_to_attempt_start_dependency_audit_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
...
/-- Toy run: actual-Li target is inherited through start-certificate slots. -/
theorem toy_endpoint_first_executable_attempt_start_certificate_slots_to_actual_li_target_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
    ...
    (AI : MainAnchoredEndpointFirstExecutableAttemptStartCertificateSlots SA) :
    A.actualLiTarget := by
  exact endpoint_first_executable_attempt_start_certificate_slots_to_actual_li_target AI

/-- Toy run: dependency audit forgets to start-certificate slots. -/
def toy_endpoint_first_executable_attempt_start_certificate_dependency_audit_to_slots_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
