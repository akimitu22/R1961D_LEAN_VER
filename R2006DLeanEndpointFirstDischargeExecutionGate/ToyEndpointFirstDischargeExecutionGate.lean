...
/-- Toy check: the execution gate forgets to the R2005D precheck. -/
def toy_endpoint_first_discharge_execution_gate_to_precheck_runs
    {PC : MainAnchoredEndpointFirstDischargeExecutionPrecheck IP}
    {PA : EndpointFirstDischargeExecutionPrecheckDependencyAudit PC}
...
/-- Toy check: the execution gate inherits the actual-Li target. -/
theorem toy_endpoint_first_discharge_execution_gate_to_actual_li_target_runs
    {PC : MainAnchoredEndpointFirstDischargeExecutionPrecheck IP}
    {PA : EndpointFirstDischargeExecutionPrecheckDependencyAudit PC}
    (EG : MainAnchoredEndpointFirstDischargeExecutionGate PA) :
    A.actualLiTarget := by
  exact endpoint_first_discharge_execution_gate_to_actual_li_target EG

/-- Toy check: the execution-gate dependency audit forgets to the gate. -/
def toy_endpoint_first_discharge_execution_gate_dependency_audit_to_gate_runs
    {PC : MainAnchoredEndpointFirstDischargeExecutionPrecheck IP}
    {PA : EndpointFirstDischargeExecutionPrecheckDependencyAudit PC}
    {EG : MainAnchoredEndpointFirstDischargeExecutionGate PA}
