...
/-- Toy run: start boundary forgets to R2018D input dependency audit. -/
def toy_endpoint_first_executable_attempt_start_boundary_to_attempt_input_dependency_audit_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
...
/-- Toy run: actual-Li target is inherited through the start boundary. -/
theorem toy_endpoint_first_executable_attempt_start_boundary_to_actual_li_target_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
    ...
    (ST : MainAnchoredEndpointFirstExecutableAttemptStartBoundary IA) :
    A.actualLiTarget := by
  exact endpoint_first_executable_attempt_start_boundary_to_actual_li_target ST

/-- Toy run: dependency audit forgets to start boundary. -/
def toy_endpoint_first_executable_attempt_start_dependency_audit_to_boundary_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
