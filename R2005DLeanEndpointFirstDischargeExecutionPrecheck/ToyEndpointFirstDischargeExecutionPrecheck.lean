...
/-- Toy check: the execution precheck forgets to the input dependency plan. -/
def toy_endpoint_first_discharge_execution_precheck_to_input_dependency_plan_runs
    {IS : MainAnchoredEndpointFirstDischargeAttemptInputSlots AA}
    {IP : EndpointFirstDischargeAttemptInputDependencyPlan IS}
...
theorem toy_endpoint_first_discharge_execution_precheck_to_actual_li_target_runs
    {IS : MainAnchoredEndpointFirstDischargeAttemptInputSlots AA}
    {IP : EndpointFirstDischargeAttemptInputDependencyPlan IS}
    (PC : MainAnchoredEndpointFirstDischargeExecutionPrecheck IP) :
    A.actualLiTarget :=
  endpoint_first_discharge_execution_precheck_to_actual_li_target PC

/-- Toy check: the dependency audit forgets to the precheck. -/
def toy_endpoint_first_discharge_execution_precheck_dependency_audit_to_precheck_runs
    {IS : MainAnchoredEndpointFirstDischargeAttemptInputSlots AA}
    {IP : EndpointFirstDischargeAttemptInputDependencyPlan IS}
    {PC : MainAnchoredEndpointFirstDischargeExecutionPrecheck IP}
