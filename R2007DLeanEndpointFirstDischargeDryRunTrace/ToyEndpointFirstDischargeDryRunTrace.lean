...
/-- Toy check: the dry-run trace forgets to the R2006D execution gate. -/
def toy_endpoint_first_discharge_dry_run_trace_to_execution_gate_runs
    {GATE : MainAnchoredEndpointFirstDischargeExecutionGate PA}
    {GA : EndpointFirstDischargeExecutionGateDependencyAudit GATE}
    (T : MainAnchoredEndpointFirstDischargeDryRunTrace GA) :
    MainAnchoredEndpointFirstDischargeExecutionGate PA :=
  endpoint_first_discharge_dry_run_trace_to_execution_gate T

/-- Toy check: the dry-run trace inherits the actual-Li target. -/
theorem toy_endpoint_first_discharge_dry_run_trace_to_actual_li_target_runs
    {GATE : MainAnchoredEndpointFirstDischargeExecutionGate PA}
    {GA : EndpointFirstDischargeExecutionGateDependencyAudit GATE}
    (T : MainAnchoredEndpointFirstDischargeDryRunTrace GA) :
    A.actualLiTarget := by
  exact endpoint_first_discharge_dry_run_trace_to_actual_li_target T

/-- Toy check: the dry-run trace dependency audit forgets to the trace. -/
def toy_endpoint_first_discharge_dry_run_trace_dependency_audit_to_trace_runs
    {GATE : MainAnchoredEndpointFirstDischargeExecutionGate PA}
    {GA : EndpointFirstDischargeExecutionGateDependencyAudit GATE}
    {T : MainAnchoredEndpointFirstDischargeDryRunTrace GA}
