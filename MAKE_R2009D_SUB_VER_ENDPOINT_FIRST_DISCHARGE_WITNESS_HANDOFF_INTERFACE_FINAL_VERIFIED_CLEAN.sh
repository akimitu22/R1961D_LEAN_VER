...
TARGET="R2009DLeanEndpointFirstDischargeWitnessHandoffInterface"
LOG="VERIFY_LOG_CODESPACES_R2009D_ENDPOINT_FIRST_DISCHARGE_WITNESS_HANDOFF_INTERFACE.txt"
STATUS="VERIFY_STATUS_R2009D_ENDPOINT_FIRST_DISCHARGE_WITNESS_HANDOFF_INTERFACE.md"
BUNDLE_BASENAME="R2009D_SUB_VER_ENDPOINT_FIRST_DISCHARGE_WITNESS_HANDOFF_INTERFACE_FINAL_VERIFIED_CLEAN"
OUT_ZIP="${BUNDLE_BASENAME}.zip"
OUT_SHA="${BUNDLE_BASENAME}.sha256"
MIN_JOBS=303
FINAL_MANIFEST="MANIFEST_R2009D_FINAL.txt"
FINAL_PATCH_MANIFEST="PATCH_MANIFEST_R2009D_FINAL.txt"
FINAL_SUMS="SHA256SUMS_R2009D_FINAL.txt"
PROJECT_ROOT="$(pwd)"
...
if ! grep -q "${TARGET}" lakefile.lean; then
  echo "ERROR: lakefile.lean does not mention ${TARGET}. Apply and verify R2009D first." >&2
  exit 1
fi

if [[ ! -f "${STATUS}" ]]; then
  echo "ERROR: ${STATUS} not found. Apply and verify R2009D first." >&2
  exit 1
fi
...
STAGE_ROOT="$(mktemp -d "${TMPDIR:-/tmp}/r2009d_clean_bundle_stage.XXXXXX")"
...
# MANIFEST — R2009D final clean export package

## Package scope

This is the R1961D–R2009D Lean support package clean-export manifest.
It is modeled on the R1974D and R1997D clean sub-version package layout, but
extends the verified endpoint spine through the R2009D first-discharge witness
handoff interface layer.
...
## New R2008D/R2009D files expected in this export

\`\`\`text
R2008DLeanEndpointFirstDischargeDryRunResultSlots.lean
R2008DLeanEndpointFirstDischargeDryRunResultSlots/EndpointFirstDischargeDryRunResultSlots.lean
R2008DLeanEndpointFirstDischargeDryRunResultSlots/EndpointFirstDischargeDryRunResultDependencyAudit.lean
R2008DLeanEndpointFirstDischargeDryRunResultSlots/EndpointFirstDischargeDryRunResultBridge.lean
R2008DLeanEndpointFirstDischargeDryRunResultSlots/ToyEndpointFirstDischargeDryRunResultSlots.lean
R2008D_ENDPOINT_FIRST_DISCHARGE_DRY_RUN_RESULT_SLOTS_LEDGER.md
R2008D_FORTY_SEVENTH_BEST_STEP.md
VERIFY_STATUS_R2008D_ENDPOINT_FIRST_DISCHARGE_DRY_RUN_RESULT_SLOTS.md

R2009DLeanEndpointFirstDischargeWitnessHandoffInterface.lean
R2009DLeanEndpointFirstDischargeWitnessHandoffInterface/EndpointFirstDischargeWitnessHandoffSlots.lean
R2009DLeanEndpointFirstDischargeWitnessHandoffInterface/EndpointFirstDischargeWitnessHandoffDependencyAudit.lean
R2009DLeanEndpointFirstDischargeWitnessHandoffInterface/EndpointFirstDischargeWitnessHandoffBridge.lean
R2009DLeanEndpointFirstDischargeWitnessHandoffInterface/ToyEndpointFirstDischargeWitnessHandoffInterface.lean
R2009D_ENDPOINT_FIRST_DISCHARGE_WITNESS_HANDOFF_INTERFACE_LEDGER.md
R2009D_FORTY_EIGHTH_BEST_STEP.md
R2009D_COMBINED_PATCH_MANIFEST.txt
VERIFY_STATUS_R2009D_ENDPOINT_FIRST_DISCHARGE_WITNESS_HANDOFF_INTERFACE.md
VERIFY_LOG_CODESPACES_R2009D_ENDPOINT_FIRST_DISCHARGE_WITNESS_HANDOFF_INTERFACE.txt
SHA256SUMS_R2009D_COMBINED_ENDPOINT_WITNESS_HANDOFF_INTERFACE.txt
\`\`\`
...
${FINAL_SUMS}
R2009D_FINAL_VERIFIED_CLEAN_EXPORT_NOTE.md
MAKE_R2009D_SUB_VER_ENDPOINT_FIRST_DISCHARGE_WITNESS_HANDOFF_INTERFACE_FINAL_VERIFIED_CLEAN.sh
\`\`\`

## Non-claim boundary

This package is a Lean proof-system / proof-obligation / proof-route /
dry-run-result / witness-handoff-interface package. It does not supply endpoint
witnesses, execute the endpoint proof kernel, discharge a concrete endpoint
lemma, or prove the endpoint estimate, boundary-error estimate,
...
# PATCH MANIFEST — R2009D final clean export

This file records the clean-export packaging boundary for the R2009D sub-version
package.
