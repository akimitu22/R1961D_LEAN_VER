...
latest = "R2057DLeanEndpointFirstConcreteObligationLocalDischargeClosureObligationMap"
libs = [
    "R2056DLeanEndpointFirstConcreteObligationLocalDischargeSkeletonFillingPlan",
    "R2057DLeanEndpointFirstConcreteObligationLocalDischargeClosureObligationMap",
]
...
m.write_text(t)
print("Updated lakefile.lean and Main.lean for R2056D/R2057D local-discharge-closure layers.")
APPLYPY
