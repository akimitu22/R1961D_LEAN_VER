...
/-- Toy check: result slots forget to the R2007D dry-run trace. -/
def toy_endpoint_first_discharge_dry_run_result_slots_to_trace_runs
    {TR : MainAnchoredEndpointFirstDischargeDryRunTrace GA}
    {TA : EndpointFirstDischargeDryRunTraceDependencyAudit TR}
...
/-- Toy check: result slots inherit the actual-Li target. -/
theorem toy_endpoint_first_discharge_dry_run_result_slots_to_actual_li_target_runs
    {TR : MainAnchoredEndpointFirstDischargeDryRunTrace GA}
    {TA : EndpointFirstDischargeDryRunTraceDependencyAudit TR}
    (RS : MainAnchoredEndpointFirstDischargeDryRunResultSlots TA) :
    A.actualLiTarget := by
  exact endpoint_first_discharge_dry_run_result_slots_to_actual_li_target RS

/-- Toy check: result dependency audit forgets to result slots. -/
def toy_endpoint_first_discharge_dry_run_result_dependency_audit_to_slots_runs
    {TR : MainAnchoredEndpointFirstDischargeDryRunTrace GA}
    {TA : EndpointFirstDischargeDryRunTraceDependencyAudit TR}
    {RS : MainAnchoredEndpointFirstDischargeDryRunResultSlots TA}
