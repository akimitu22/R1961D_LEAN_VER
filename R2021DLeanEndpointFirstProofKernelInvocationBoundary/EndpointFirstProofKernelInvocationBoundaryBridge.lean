...
/-- R2021D invocation boundary inherits the actual-Li target through R2018D. -/
theorem endpoint_first_proof_kernel_invocation_boundary_to_actual_li_target
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
    ...
    (ST : MainAnchoredEndpointFirstProofKernelInvocationBoundary IA) :
    A.actualLiTarget := by
  exact R2020DLeanEndpointFirstExecutableAttemptStartCertificateSlots.endpoint_first_executable_attempt_start_certificate_dependency_audit_to_actual_li_target
    (endpoint_first_proof_kernel_invocation_boundary_to_attempt_start_certificate_dependency_audit ST)

/-- R2021D dependency audit inherits the same target through invocation boundary. -/
theorem endpoint_first_proof_kernel_invocation_dependency_audit_to_actual_li_target
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
    ...
    A.actualLiTarget := by
  exact endpoint_first_proof_kernel_invocation_boundary_to_actual_li_target
    (endpoint_first_proof_kernel_invocation_dependency_audit_to_boundary SD)

/-- R2021D non-claim certificate. -/
structure EndpointFirstExecutableAttemptStartCertificate where
  recordsEndpointFirstProofKernelInvocationBoundary : Bool
  recordsEndpointFirstProofKernelInvocationDependencyAudit : Bool
  preservesR2018ExecutableAttemptStartCertificateSlots : Bool
...
/-- R2021D records an proof-kernel invocation boundary but does not invoke or execute the proof kernel. -/
def r2021EndpointFirstExecutableAttemptStartCertificate :
    EndpointFirstExecutableAttemptStartCertificate :=
  { recordsEndpointFirstProofKernelInvocationBoundary := true
    recordsEndpointFirstProofKernelInvocationDependencyAudit := true
    preservesR2018ExecutableAttemptStartCertificateSlots := true
...
theorem r2021_sixtieth_step_records_endpoint_first_proof_kernel_invocation_boundary :
    r2021EndpointFirstExecutableAttemptStartCertificate.recordsEndpointFirstProofKernelInvocationBoundary = true := by
  rfl

theorem r2021_sixtieth_step_records_endpoint_first_proof_kernel_invocation_dependency_audit :
    r2021EndpointFirstExecutableAttemptStartCertificate.recordsEndpointFirstProofKernelInvocationDependencyAudit = true := by
  rfl

theorem r2021_sixtieth_step_is_proof_kernel_invocation_boundary_not_attempt_start :
    r2021EndpointFirstExecutableAttemptStartCertificate.startsExecutableAttemptHere = false := by
  rfl

theorem r2021_sixtieth_step_does_not_claim_rh_formalization :
    r2021EndpointFirstExecutableAttemptStartCertificate.claimsFullRHFormalization = false := by
  rfl
