...
/-- Toy run: witness packet boundary forgets to R2014D result slots. -/
def toy_endpoint_first_execution_witness_packet_boundary_to_rehearsal_result_slots_runs
    {RR : MainAnchoredEndpointFirstRehearsalResultSlots REA}
    {RRA : EndpointFirstRehearsalResultDependencyAudit RR}
...
/-- Toy run: actual-Li target is inherited through witness packet boundary. -/
theorem toy_endpoint_first_execution_witness_packet_boundary_to_actual_li_target_runs
    {RR : MainAnchoredEndpointFirstRehearsalResultSlots REA}
    {RRA : EndpointFirstRehearsalResultDependencyAudit RR}
    (WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA) :
    A.actualLiTarget := by
  exact endpoint_first_execution_witness_packet_boundary_to_actual_li_target WB

/-- Toy run: dependency audit forgets to witness packet boundary. -/
def toy_endpoint_first_execution_witness_packet_dependency_audit_to_boundary_runs
    {RR : MainAnchoredEndpointFirstRehearsalResultSlots REA}
    {RRA : EndpointFirstRehearsalResultDependencyAudit RR}
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
