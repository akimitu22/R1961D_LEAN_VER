...
/-- Dependency audit for R2035D final RH-claim boundary records. -/
structure EndpointFinalRHClaimDependencyAudit
...
/-- The R2035D dependency audit preserves the analytic target. -/
theorem endpoint_final_rh_claim_dependency_audit_to_actual_li_target
    ...
    (O : EndpointFinalRHClaimDependencyAudit N) : A.actualLiTarget :=
  O.actualLiTarget

/-- R2035D dependency audit remains pre-RH-proof. -/
theorem r2035_seventy_fourth_step_records_final_rh_claim_dependency_audit_only : True :=
  trivial
