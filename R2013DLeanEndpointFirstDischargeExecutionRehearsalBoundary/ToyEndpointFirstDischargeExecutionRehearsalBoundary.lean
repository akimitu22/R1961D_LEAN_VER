...
/-- Toy run: a rehearsal boundary forgets to R2012D payload slots. -/
def toy_endpoint_first_discharge_execution_rehearsal_boundary_to_payload_slots_runs
    {HS : MainAnchoredEndpointFirstExecutionHandoffPayloadSlots EA}
    {HA : EndpointFirstExecutionHandoffPayloadDependencyAudit HS}
...
/-- Toy run: actual-Li target is inherited through the rehearsal boundary. -/
theorem toy_endpoint_first_discharge_execution_rehearsal_boundary_to_actual_li_target_runs
    {HS : MainAnchoredEndpointFirstExecutionHandoffPayloadSlots EA}
    {HA : EndpointFirstExecutionHandoffPayloadDependencyAudit HS}
    (RB : MainAnchoredEndpointFirstDischargeExecutionRehearsalBoundary HA) :
    A.actualLiTarget := by
  exact endpoint_first_discharge_execution_rehearsal_boundary_to_actual_li_target RB

/-- Toy run: dependency audit forgets to the rehearsal boundary. -/
def toy_endpoint_first_discharge_execution_rehearsal_dependency_audit_to_boundary_runs
    {HS : MainAnchoredEndpointFirstExecutionHandoffPayloadSlots EA}
    {HA : EndpointFirstExecutionHandoffPayloadDependencyAudit HS}
    {RB : MainAnchoredEndpointFirstDischargeExecutionRehearsalBoundary HA}
