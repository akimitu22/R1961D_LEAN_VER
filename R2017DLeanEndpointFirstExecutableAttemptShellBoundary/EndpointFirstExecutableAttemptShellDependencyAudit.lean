...
/-- Kinds in the dependency audit for the executable-attempt shell boundary. -/
inductive EndpointFirstExecutableAttemptShellDependencyKind where
  | witnessValidationAuditDependency
  | attemptShellBoundaryDependency
  | attemptInputCarrierDependency
  | laterAttemptStartDependency
  | nonClaimDependency
  deriving DecidableEq, Repr

/-- One dependency item for R2017D. -/
structure EndpointFirstExecutableAttemptShellDependencyItem
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
    (SH : MainAnchoredEndpointFirstExecutableAttemptShellBoundary VA) where
  kind : EndpointFirstExecutableAttemptShellDependencyKind
  itemIndex : Nat
  attemptShellCarrier : Type
  validationAuditCarrier : Type
  recordsAttemptShellDependency : Prop
  recordsAttemptInputCarrierDependency : Prop
  recordsLaterAttemptStartDependency : Prop
...
/-- Dependency audit for R2017D executable-attempt shell boundary. -/
structure EndpointFirstExecutableAttemptShellDependencyAudit
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
    (SH : MainAnchoredEndpointFirstExecutableAttemptShellBoundary VA) where
  witnessValidationAuditDependency : EndpointFirstExecutableAttemptShellDependencyItem SH
  attemptShellBoundaryDependency : EndpointFirstExecutableAttemptShellDependencyItem SH
  attemptInputCarrierDependency : EndpointFirstExecutableAttemptShellDependencyItem SH
  laterAttemptStartDependency : EndpointFirstExecutableAttemptShellDependencyItem SH
  nonClaimDependency : EndpointFirstExecutableAttemptShellDependencyItem SH
  dependencyAuditCarrier : Type
  attemptShellCarrier : Type
  validationAuditCarrier : Type
  coversAllAttemptShellItems : Prop
  preservesWitnessValidationAudit : Prop
...
/-- Forget R2017D dependency audit to the executable-attempt shell boundary. -/
def endpoint_first_executable_attempt_shell_dependency_audit_to_boundary
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
    {SH : MainAnchoredEndpointFirstExecutableAttemptShellBoundary VA}
    (_SA : EndpointFirstExecutableAttemptShellDependencyAudit SH) :
    MainAnchoredEndpointFirstExecutableAttemptShellBoundary VA :=
  SH

/-- Forget R2017D dependency audit to R2016D validation slots. -/
def endpoint_first_executable_attempt_shell_dependency_audit_to_witness_validation_slots
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
  ...
  endpoint_first_executable_attempt_shell_boundary_to_witness_validation_slots
    (endpoint_first_executable_attempt_shell_dependency_audit_to_boundary SA)

/-- Record that R2017D dependency audit remains non-executing. -/
def endpoint_first_executable_attempt_shell_dependency_audit_records_no_execution_here
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
    {SH : MainAnchoredEndpointFirstExecutableAttemptShellBoundary VA}
    (SA : EndpointFirstExecutableAttemptShellDependencyAudit SH) : Prop :=
  SA.nonClaimBoundary ∧
  SA.noExecutableAttemptStartedHere ∧
  SA.noWitnessValidatedHere ∧
  SA.noEndpointKernelExecutedHere ∧
  SA.noConcreteEndpointLemmaDischargedHere ∧
  SA.noEndpointEstimateClosedHere ∧
  SA.noExplicitFormulaClosedHere ∧
  SA.noRHClosedHere ∧
  endpoint_first_executable_attempt_shell_boundary_records_no_execution_here
    (endpoint_first_executable_attempt_shell_dependency_audit_to_boundary SA)
