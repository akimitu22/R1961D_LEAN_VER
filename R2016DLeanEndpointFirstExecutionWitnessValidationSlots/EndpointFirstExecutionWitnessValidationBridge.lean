...
/-- R2016D validation slots inherit the actual-Li target through R2015D. -/
theorem endpoint_first_execution_witness_validation_slots_to_actual_li_target
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    (WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD) :
    A.actualLiTarget := by
  exact R2015DLeanEndpointFirstExecutionWitnessPacketBoundary.endpoint_first_execution_witness_packet_dependency_audit_to_actual_li_target
    (endpoint_first_execution_witness_validation_slots_to_witness_packet_dependency_audit WV)

/-- R2016D dependency audit inherits the same target through validation slots. -/
theorem endpoint_first_execution_witness_validation_dependency_audit_to_actual_li_target
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    (VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV) :
    A.actualLiTarget := by
  exact endpoint_first_execution_witness_validation_slots_to_actual_li_target
    (endpoint_first_execution_witness_validation_dependency_audit_to_slots VA)

/-- R2016D non-claim certificate. -/
structure EndpointFirstExecutionWitnessValidationCertificate where
  recordsEndpointFirstExecutionWitnessValidationSlots : Bool
  recordsEndpointFirstExecutionWitnessValidationDependencyAudit : Bool
  preservesR2015WitnessPacketBoundary : Bool
  preservesHistoricalMainLeanCheckSpine : Bool
  preparesLaterExecutableAttemptShell : Bool
...
/-- R2016D records validation slots but does not validate witnesses. -/
def r2016EndpointFirstExecutionWitnessValidationCertificate :
    EndpointFirstExecutionWitnessValidationCertificate :=
  { recordsEndpointFirstExecutionWitnessValidationSlots := true
    recordsEndpointFirstExecutionWitnessValidationDependencyAudit := true
    preservesR2015WitnessPacketBoundary := true
    preservesHistoricalMainLeanCheckSpine := true
    preparesLaterExecutableAttemptShell := true
...
theorem r2016_fifty_fifth_step_records_endpoint_first_execution_witness_validation_slots :
    r2016EndpointFirstExecutionWitnessValidationCertificate.recordsEndpointFirstExecutionWitnessValidationSlots = true := by
  rfl

theorem r2016_fifty_fifth_step_records_endpoint_first_execution_witness_validation_dependency_audit :
    r2016EndpointFirstExecutionWitnessValidationCertificate.recordsEndpointFirstExecutionWitnessValidationDependencyAudit = true := by
  rfl

theorem r2016_fifty_fifth_step_is_validation_slots_not_validation_execution :
    r2016EndpointFirstExecutionWitnessValidationCertificate.validatesExecutionWitnessHere = false := by
  rfl

theorem r2016_fifty_fifth_step_does_not_claim_rh_formalization :
    r2016EndpointFirstExecutionWitnessValidationCertificate.claimsFullRHFormalization = false := by
  rfl
