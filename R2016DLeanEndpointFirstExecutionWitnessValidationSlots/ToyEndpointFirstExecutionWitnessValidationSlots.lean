...
/-- Toy run: validation slots forget to R2015D witness-packet dependency audit. -/
def toy_endpoint_first_execution_witness_validation_slots_to_witness_packet_dependency_audit_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
...
/-- Toy run: actual-Li target is inherited through validation slots. -/
theorem toy_endpoint_first_execution_witness_validation_slots_to_actual_li_target_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    (WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD) :
    A.actualLiTarget := by
  exact endpoint_first_execution_witness_validation_slots_to_actual_li_target WV

/-- Toy run: dependency audit forgets to validation slots. -/
def toy_endpoint_first_execution_witness_validation_dependency_audit_to_slots_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
