...
/-- Dependency audit for the R2053D local discharge candidate registry. -/
structure EndpointFirstConcreteObligationLocalDischargeCandidateRegistryDependencyAudit
    ...
    (AH : MainAnchoredEndpointFirstConcreteObligationLocalDischargeCandidateRegistry AG) where
  auditItemCount : Nat
  attachedToTraceReplayCheckpoint : Prop
  ...
  recordsAllLocalCandidatesRemainOpen : Prop
  recordsNoLocalCandidateProofTerm : Prop
  recordsFutureCandidateClosurePermission : Prop
  actualLiTarget : A.actualLiTarget

/-- The R2053D dependency audit preserves the analytic target. -/
theorem endpoint_first_concrete_obligation_local_discharge_candidate_registry_dependency_audit_to_actual_li_target
    ...
    (AI : EndpointFirstConcreteObligationLocalDischargeCandidateRegistryDependencyAudit AH) : A.actualLiTarget :=
  AI.actualLiTarget

/-- R2053D dependency audit remains a local-candidate registry audit only. -/
theorem r2053_ninety_second_step_dependency_audit_is_local_candidate_registry_only : True :=
  trivial
