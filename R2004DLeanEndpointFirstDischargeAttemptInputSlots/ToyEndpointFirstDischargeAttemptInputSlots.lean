...
/-- Toy check: the input-slot forgetful map runs. -/
def toy_endpoint_first_discharge_attempt_input_slots_to_attempt_boundary_runs
    {AB : MainAnchoredEndpointFirstDischargeAttemptBoundary PD}
    {AA : EndpointFirstDischargeAttemptDependencyAudit AB}
    (IS : MainAnchoredEndpointFirstDischargeAttemptInputSlots AA) :
    MainAnchoredEndpointFirstDischargeAttemptBoundary PD :=
  endpoint_first_discharge_attempt_input_slots_to_attempt_boundary IS

/-- Toy check: the target bridge is executable as a theorem. -/
theorem toy_endpoint_first_discharge_attempt_input_slots_to_actual_li_target_runs
    {AB : MainAnchoredEndpointFirstDischargeAttemptBoundary PD}
    {AA : EndpointFirstDischargeAttemptDependencyAudit AB}
    (IS : MainAnchoredEndpointFirstDischargeAttemptInputSlots AA) :
    A.actualLiTarget :=
  endpoint_first_discharge_attempt_input_slots_to_actual_li_target IS

/-- Toy check: the input dependency plan forgets to slots. -/
def toy_endpoint_first_discharge_attempt_input_dependency_plan_to_slots_runs
    {AB : MainAnchoredEndpointFirstDischargeAttemptBoundary PD}
    {AA : EndpointFirstDischargeAttemptDependencyAudit AB}
    {IS : MainAnchoredEndpointFirstDischargeAttemptInputSlots AA}
