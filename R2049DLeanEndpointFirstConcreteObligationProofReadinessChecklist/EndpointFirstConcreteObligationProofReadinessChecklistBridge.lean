...
/-- Bridge from R2049D proof-readiness checklist to its dependency audit. -/
def endpoint_first_concrete_obligation_proof_readiness_checklist_to_dependency_audit
    ...
    EndpointFirstConcreteObligationProofReadinessChecklistDependencyAudit AD :=
  { auditItemCount := AD.readinessChecklistStageCount
    attachedToLemmaDependencyGraph := AD.allReadinessItemsStillOpen
    recordsEndpointEstimateReadiness := AD.recordsEndpointEstimateReadiness
    recordsExplicitFormulaReadiness := AD.recordsExplicitFormulaReadiness
    recordsTransferAssemblyReadiness := AD.recordsTransferAssemblyReadiness
    recordsFiniteAbelReductionReadiness := AD.recordsFiniteAbelReductionReadiness
    recordsProofKernelConnectionReadiness := AD.recordsProofKernelConnectionReadiness
    recordsAllReadinessItemsStillOpen := AD.allReadinessItemsStillOpen
    recordsNextExecutableAttemptPermission := AD.permitsNextExecutableProofAttempt
    actualLiTarget := AD.actualLiTarget }

/-- The R2049D bridge preserves the analytic target. -/
theorem endpoint_first_concrete_obligation_proof_readiness_checklist_bridge_to_actual_li_target
  ...
  (endpoint_first_concrete_obligation_proof_readiness_checklist_to_dependency_audit AD).actualLiTarget
