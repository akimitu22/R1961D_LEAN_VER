...
/-- Dependency audit for R2041D final submission boundary. -/
structure EndpointFinalSubmissionDependencyAudit
...
/-- The R2041D dependency audit preserves the analytic target. -/
theorem endpoint_final_submission_dependency_audit_to_actual_li_target
    ...
    (W : EndpointFinalSubmissionDependencyAudit V) : A.actualLiTarget :=
  W.actualLiTarget

/-- R2041D dependency audit remains non-claiming. -/
theorem r2041_eightieth_step_records_final_submission_dependency_audit_only : True :=
  trivial
