...
/-- Toy run: a payload-slot record forgets to the R2011D execution handoff boundary. -/
def toy_endpoint_first_execution_handoff_payload_slots_to_execution_handoff_boundary_runs
    {EB : MainAnchoredEndpointFirstDischargeExecutionHandoffBoundary VA}
    {EA : EndpointFirstDischargeExecutionHandoffDependencyAudit EB}
...
/-- Toy run: the actual-Li target is inherited through the payload slots. -/
theorem toy_endpoint_first_execution_handoff_payload_slots_to_actual_li_target_runs
    {EB : MainAnchoredEndpointFirstDischargeExecutionHandoffBoundary VA}
    {EA : EndpointFirstDischargeExecutionHandoffDependencyAudit EB}
    (HS : MainAnchoredEndpointFirstExecutionHandoffPayloadSlots EA) :
    A.actualLiTarget := by
  exact endpoint_first_execution_handoff_payload_slots_to_actual_li_target HS

/-- Toy run: dependency audit forgets to the payload slots. -/
def toy_endpoint_first_execution_handoff_payload_dependency_audit_to_slots_runs
    {EB : MainAnchoredEndpointFirstDischargeExecutionHandoffBoundary VA}
    {EA : EndpointFirstDischargeExecutionHandoffDependencyAudit EB}
    {HS : MainAnchoredEndpointFirstExecutionHandoffPayloadSlots EA}
