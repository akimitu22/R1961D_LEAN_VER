...
/-- Toy check: validation slots forget to R2009D witness handoff interface. -/
def toy_endpoint_first_witness_validation_slots_to_witness_handoff_interface_runs
    {WI : MainAnchoredEndpointFirstDischargeWitnessHandoffInterface RA}
    {WA : EndpointFirstDischargeWitnessHandoffDependencyAudit WI}
...
/-- Toy check: validation slots inherit the actual-Li target. -/
theorem toy_endpoint_first_witness_validation_slots_to_actual_li_target_runs
    {WI : MainAnchoredEndpointFirstDischargeWitnessHandoffInterface RA}
    {WA : EndpointFirstDischargeWitnessHandoffDependencyAudit WI}
    (VS : MainAnchoredEndpointFirstWitnessValidationSlots WA) :
    A.actualLiTarget := by
  exact endpoint_first_witness_validation_slots_to_actual_li_target VS

/-- Toy check: validation dependency audit forgets to validation slots. -/
def toy_endpoint_first_witness_validation_dependency_audit_to_slots_runs
    {WI : MainAnchoredEndpointFirstDischargeWitnessHandoffInterface RA}
    {WA : EndpointFirstDischargeWitnessHandoffDependencyAudit WI}
    {VS : MainAnchoredEndpointFirstWitnessValidationSlots WA}
