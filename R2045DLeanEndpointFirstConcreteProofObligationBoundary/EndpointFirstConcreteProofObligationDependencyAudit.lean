...
/-- Dependency audit for the R2045D first concrete proof-obligation boundary. -/
structure EndpointFirstConcreteProofObligationDependencyAudit
  ...
  auditItemCount : Nat
  attachedToFirstConcreteProofBoundary : Prop
  recordsEndpointEstimateSubgoal : Prop
  recordsExplicitFormulaDependency : Prop
  recordsNoEndpointEstimateProofYet : Prop
  recordsNoRHProofYet : Prop
  actualLiTarget : A.actualLiTarget

/-- The R2045D dependency audit preserves the analytic target. -/
theorem endpoint_first_concrete_proof_obligation_dependency_audit_to_actual_li_target
    ...
    (AA : EndpointFirstConcreteProofObligationDependencyAudit Z) : A.actualLiTarget :=
  AA.actualLiTarget

/-- R2045D dependency audit records the first concrete proof boundary only. -/
theorem r2045_eighty_fourth_step_records_first_concrete_dependency_audit_only : True :=
  trivial
