...
/-- Toy run: input slots forget to R2017D attempt-shell dependency audit. -/
def toy_endpoint_first_executable_attempt_input_slots_to_attempt_shell_dependency_audit_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
...
/-- Toy run: actual-Li target is inherited through input slots. -/
theorem toy_endpoint_first_executable_attempt_input_slots_to_actual_li_target_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
    ...
    (AI : MainAnchoredEndpointFirstExecutableAttemptInputSlots SA) :
    A.actualLiTarget := by
  exact endpoint_first_executable_attempt_input_slots_to_actual_li_target AI

/-- Toy run: dependency audit forgets to input slots. -/
def toy_endpoint_first_executable_attempt_input_dependency_audit_to_slots_runs
    {WB : MainAnchoredEndpointFirstExecutionWitnessPacketBoundary RRA}
    {WD : EndpointFirstExecutionWitnessPacketDependencyAudit WB}
    {WV : MainAnchoredEndpointFirstExecutionWitnessValidationSlots WD}
    {VA : EndpointFirstExecutionWitnessValidationDependencyAudit WV}
